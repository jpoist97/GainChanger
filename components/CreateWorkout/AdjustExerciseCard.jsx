         ...
         <ContentWrapper>
            <StyledIcon
               ...
               onPress={() =>
                  sets
                     ? parseInt(sets) <= 0 ||
                       setSets((parseInt(sets) - 1).toString())
                     : sets
               }
            />
            <StyledInput
            ...
            <StyledIcon
               ...
               color="white"
               onPress={() =>
                  sets ? setSets((parseInt(sets) + 1).toString()) : setSets('1')
               }
            />
            {isReps ? (
               <ContentWrapper>
                  <StyledIcon
                     ...
                     onPress={() =>
                        reps
                           ? parseInt(reps) <= 0 ||
                             setReps((parseInt(reps) - 1).toString())
                           : reps
                     }
                  />
                  <StyledInput
               ...
               <ContentWrapper>
                  <StyledIcon
                     ...
                     onPress={() =>
                        seconds
                           ? parseInt(seconds) < 5 ||
                             setSeconds((parseInt(seconds) - 5).toString())
                           : seconds
                     }
                  />
                  <StyledInput
