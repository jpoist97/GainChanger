   ...
   const renderCard = ({ item: { left, right } }) => (
      <WorkoutCardPair>
         <WorkoutCard
            ...
            onPress={() => {
               navigation.navigate('Log Workout', { workoutId: left.id });
            }}
         />
         {right ? (
            <WorkoutCard
               ...
               onPress={() => {
                  navigation.navigate('Log Workout', { workoutId: right.id });
               }}
            />
         ) : (
            <WorkoutCard color="#00000000" name="" displayEllipses={false} />
         )}
      </WorkoutCardPair>
   );
