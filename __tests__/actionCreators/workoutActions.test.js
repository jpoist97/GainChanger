...
const workouts = [
   {
      exercises: [
         { exerciseId: 'exercise1', exerciseName: 'Push Press', sets: {} },
      ],
   ...
   {
      exercises: [
         { exerciseId: 'exercise2', exerciseName: 'Chest Press', sets: {} },
      ],
      lastPerformed: '2021-02-18',
      muscleGroups: 'Chest',
      name: 'Push2',
   },
];
...
describe('workoutActions tests', () => {
   ...
   describe('updateWorkout test', () => {
      it('should dispatch UPDATE_WORKOUT with updated workout document', () => {
         ...
         // Act
         const thunkFunction = workoutActions.updateWorkout(
            testWorkoutId,
            newWorkoutContent
         );
   ...
   describe('updateWorkoutExercises test', () => {
      it('should return an appropriate action', () => {
         ...
         // Act
         const action = workoutActions.updateWorkoutExercises(
            testWorkoutId,
            updatedExercises
         );
